...
%>
                   <li><a href="ShoppingCartServlet">(<%=num%>)Cart</a></li>
 ...
 <div >
    <div>
       ...
       <form action="ShoppingCartServlet" method="post">
           <td colspan="3" ><input type="hidden" name="itemID" value="<%=item.getItemID()%>"/>
           ...
           <td colspan="3"><input type="text" name="txtQuantity" value="1" style="width: 60px;" onKeyPress="return checkIt(event)"/></td>
           <td colspan="3"><input type="submit" name="decision" value="Add to cart"/></td>
       </form>
       </tr>   
               <%
             }
