...
%>
 ...
 <div >
    <div>
        <br/>
        <br/>
        <center><b><h1 style="font-weight: bold;">Item(s)</h1><b><hr/><br/></center>
                     <%
       ...
       <%
         ...
         {
             %>
                    <table  class="gridtable" style="width: 560px;"><form action="checkOutServlet" method="post">
                        <tr>
       ...
       <tr>
           ...
           <td colspan="3"><%=item.getQuantity()%></td>
            <td colspan="3"><%=item.getPrice()%></td>
             ...
             %>
             <tr>   
            <td colspan="12"><input type="submit" name="decision" value="remove from cart"/></td> 
