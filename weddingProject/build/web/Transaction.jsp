...
%>
 ...
 <div >
    <div>
        <br/>
        <br/>
        <center><b><h1 style="font-weight: bold;">Item to Purchase</h1><b><hr/><br/></center>
        ...
        %>
                    ...
                    <p>Account number :<input type="text" name="AcctNumber" value=""/></p>
                    <p>Account type :<select name="Type">
            <option>---</option>
            <option>Saving</option>
            <option>Cheque</option>
        </select></p>
        <p><input type="submit" name="decision" value="Purchase"/></p>
                    </form>
       ...
       <tr>
           ...
           <td colspan="3"><%=item.getQuantity()%></td>
            ...
            <td colspan="15"><b>Total(R):<%=total%></b></td>
             </tr>
       <%
